...
void update_phantom_enemy(u8 enemy_)
{
	...
	{
		phantom_enemies.enemy_x[phantom_enemies.group_members] = rand_(17) * 16 + 8 + scroll_x;
		phantom_enemies.enemy_y[phantom_enemies.group_members] = rand_(10) * 16 + 8;
